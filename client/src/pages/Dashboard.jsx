...
function Dashboard() {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://habittracker-production-8d4a.up.railway.app/api/habits/${id}`, getAuthHeaders());
  ...
  const handleCheckIn = async (id) => {
    try {
      const response = await axios.put(`https://habittracker-production-8d4a.up.railway.app/api/habits/${id}/checkin`, {}, getAuthHeaders());
