...
function Dashboard() {
  ...
  useEffect(() => {
    const fetchHabits = async () => {
      try {
        ...
        const response = await axios.get('habittracker-production-8d4a.up.railway.app/api/habits', getAuthHeaders());
  ...
  const handleAddHabit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('habittracker-production-8d4a.up.railway.app/api/habits', newHabit, getAuthHeaders());
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`habittracker-production-8d4a.up.railway.app/api/habits/${id}`, getAuthHeaders());
  ...
  const handleCheckIn = async (id) => {
    try {
      const response = await axios.put(`habittracker-production-8d4a.up.railway.app/api/habits/${id}/checkin`, {}, getAuthHeaders());
